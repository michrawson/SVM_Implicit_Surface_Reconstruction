...
3D printers are becoming more powerful and need accurate models to be useful.

Manipulating all of the data together, at once, is too taxing for hardware. Use of a compact model is highly desirable. 
